...
private let log = Logger(subsystem: "com.mtkg.pointerkun", category: "update")
...
struct UpdateService {
    static let repoFullName = "m-tkg/pointerkun"
    static let apiBase = "https://api.github.com"
    private static let userAgent = "Pointerkun"
    ...
    func downloadReleaseZip(_ release: ReleaseInfo, into directory: URL) async throws -> URL {
        ...
        let destination = directory.appendingPathComponent("Pointerkun.zip")
